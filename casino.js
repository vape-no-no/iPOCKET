  ...
  const buildSlots = wrap => {
    ...
    const drawSym = (sym, sz, alpha) => {
      ...
      if (sym === 'CHERRY') {
        ...
        ctx.beginPath(); ctx.moveTo(-r2,-h*0.10); ctx.quadraticCurveTo(0,-h*0.40,r2,-h*0.10); ctx.stroke();
        ...
        ctx.beginPath(); ctx.arc(-r2,h*0.10,r2,0,Math.PI*2); ctx.fillStyle=g1; ctx.fill();
        ctx.strokeStyle='#660000'; ctx.lineWidth=0.8; ctx.stroke();
        /* 3D gloss */
        ctx.beginPath(); ctx.ellipse(-r2-r2*0.18,h*0.01,r2*0.28,r2*0.18,-0.5,0,Math.PI*2);
        ...
        ctx.beginPath(); ctx.arc(r2,h*0.06,r2,0,Math.PI*2); ctx.fillStyle=g2; ctx.fill();
        ctx.strokeStyle='#660000'; ctx.lineWidth=0.8; ctx.stroke();

      } else if (sym==='BAR') {
        const bw=h*0.82,bh=h*0.27;
        /* 3D depth */
        rr(-bw/2+3,-bh/2+3,bw,bh,bh*0.28); ctx.fillStyle='#111'; ctx.fill();
        ...
        [-1,1].forEach(d=>{
          rr(-bw/2+2,d*gap-bh/2+2,bw,bh,bh*0.28); ctx.fillStyle='#111'; ctx.fill();
        ...
        [-1,0,1].forEach(d=>{
          rr(-bw/2+2,d*gap-bh/2+2,bw,bh,bh*0.28); ctx.fillStyle='#0a0a0a'; ctx.fill();
        ...
        ctx.beginPath(); ctx.moveTo(-br*0.66,br*0.30);
        ...
        ctx.closePath(); ctx.fillStyle='rgba(0,0,0,.4)'; ctx.fill(); ctx.restore();
        ctx.beginPath(); ctx.moveTo(-br*0.66,br*0.30);
        ctx.bezierCurveTo(-br*0.66,-br*0.36,-br*0.18,-br*0.90,0,-br*0.90);
        ctx.bezierCurveTo(br*0.18,-br*0.90,br*0.66,-br*0.36,br*0.66,br*0.30);
        ctx.closePath();
        ...
        rr(-br*0.72,br*0.22,br*1.44,br*0.20,br*0.08); ctx.fillStyle='#b08000'; ctx.fill();
        ctx.beginPath(); ctx.arc(0,br*0.44,br*0.13,0,Math.PI*2); ctx.fillStyle='#a06800'; ctx.fill();
        ctx.beginPath(); ctx.ellipse(-br*0.16,-br*0.26,br*0.22,br*0.13,-0.5,0,Math.PI*2);
        ...
        ctx.fillStyle='rgba(0,0,150,.3)'; ctx.fill(); ctx.restore();
        ctx.beginPath(); pts.forEach(([px,py],i)=>i===0?ctx.moveTo(px,py):ctx.lineTo(px,py)); ctx.closePath();
        ...
        ctx.beginPath(); ctx.ellipse(-dr*0.10,-dr*0.32,dr*0.22,dr*0.12,-0.4,0,Math.PI*2);
        ...
        ctx.fillStyle='rgba(100,0,0,.6)';
        for(let d=1;d<=4;d++){ ctx.fillText('7',d*0.8,h*0.04+d*0.7); }
        ...
        /* gloss */
        ctx.beginPath(); ctx.ellipse(-h*0.05,-h*0.10,h*0.18,h*0.08,-0.3,0,Math.PI*2);
