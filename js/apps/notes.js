...
function initNotes() {
  ...
  topBar.style.cssText = 'flex-shrink:0;display:flex;align-items:center;justify-content:space-between;padding:89px 18px 12px;border-bottom:1px solid rgba(255,255,255,.06);';
  topBar.innerHTML = `
