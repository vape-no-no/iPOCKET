...
function initGyro() {
  ...
  wrap.style.cssText = 'width:100%;height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:20px;background:#050508;padding-top:0;padding-bottom:calc(var(--sb,0px)+40px);overflow:hidden;position:relative;';
